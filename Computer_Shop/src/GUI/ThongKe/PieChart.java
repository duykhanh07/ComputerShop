...
public class PieChart extends JComponent {
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (int i = 0; i < models.size(); i++) {
            ...
            if (hoverIndex == i) {
                ...
                String detail = format.format(data.getValues())+"đ" + " (" + text + ")";
    ...
    public void shortenModel() {
    	String other_name = "khác";
    	Long other_values = 0l;
    	Color other_color;
    	if(getModelsCount()>9) {
    		other_color = models.get(0).getColor();
    		Collections.sort(models, (o1,o2)-> (int)(o1.getValues() - o2.getValues())/1000);
    		while(getModelsCount()!=9) {
    			other_values += models.get(0).getValues();
    			models.remove(0);
    		}
    		this.addData(new ModelPieChart(other_name, other_values, other_color));
    	}else {
    		return;
    	}
