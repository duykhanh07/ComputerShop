		...
		groupLayout.setHorizontalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					.addContainerGap()
					.addComponent(QLKhachHangPanel, GroupLayout.DEFAULT_SIZE, 860, Short.MAX_VALUE)
					.addContainerGap())
		);
			...
			gl_QLKhachHangPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_QLKhachHangPanel.createSequentialGroup()
					...
					.addGroup(gl_QLKhachHangPanel.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(scrollPane_1, GroupLayout.DEFAULT_SIZE, 844, Short.MAX_VALUE)
			...
			gl_QLKhachHangPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_QLKhachHangPanel.createSequentialGroup()
					...
					.addGroup(gl_QLKhachHangPanel.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_QLKhachHangPanel.createParallelGroup(Alignment.TRAILING)
							.addComponent(auto_increase_spaceLbl_3, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
							.addGroup(Alignment.LEADING, gl_QLKhachHangPanel.createSequentialGroup()
								.addGap(1)
								.addGroup(gl_QLKhachHangPanel.createParallelGroup(Alignment.BASELINE)
