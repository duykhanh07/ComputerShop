...
public class TabbedPaneCustomUI extends BasicTabbedPaneUI {
    ...
    private final MyTabbedPaneCustom tab;

    public TabbedPaneCustomUI(MyTabbedPaneCustom tab) {
        this.tab = tab;
    }
    ...
    protected void paintTabArea(Graphics g, int tabPlacement, int selectedIndex) {
        ...
        for (int i = tabPane.getTabCount() - 1; i >= 0; i--) {
            if (i != selectedIndex) {
                ...
                tabPane.setForegroundAt(i, tab.getUnselectedFontColor());
            }
        }
        paintTabBackground(g2, selectedIndex, true);
        tabPane.setForegroundAt(selectedIndex, tab.getSelectedFontColor());
        g2.dispose();
